...
target_direct = '/home/jeanettenischan/Data/data_INTENS_TMS/ProcessedData/IO_include/namingV/plots/'
direct_IO = '/home/jeanettenischan/Data/data_INTENS_TMS/ProcessedData/IO_include/namingV/group/'
    ...
    for intensity in group_avg.keys():
        ...
        for time in group_avg[intensity].keys():
            ...
            for i in range(0,len(MEP_occ[intensity][time])):
                x_occ.append(time)   
            print('There are occurrence values for {} subjects at {} and {} %RMT'.format(len(MEP_occ[intensity][time]), time, intensity))     
...
def group_IO(group_avg, timepoints):
    ...
    for time in timepoints:
        ...
        for intensity in group_avg.keys():
            ...
            print('There are ptp values for for {} subjects at {} and {} %RMT'.format(len(group_avg[intensity][time]), time, intensity))
...
with open('/home/jeanettenischan/Data/data_INTENS_TMS/ProcessedData/IO_include/namingV/groupAVG.json','w') as outfile:
    json.dump(groupAVG,outfile)

with open('/home/jeanettenischan/Data/data_INTENS_TMS/ProcessedData/IO_include/namingV/groupLOG.json','w') as outfile:
    json.dump(groupLOG,outfile)    

with open('/home/jeanettenischan/Data/data_INTENS_TMS/ProcessedData/IO_include/namingV/group_avgs.json','w') as outfile:
    json.dump(group_avg,outfile)

with open('/home/jeanettenischan/Data/data_INTENS_TMS/ProcessedData/IO_include/namingV/group_MEP_occ.json','w') as outfile:
